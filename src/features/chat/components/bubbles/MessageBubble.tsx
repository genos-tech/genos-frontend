...
export const MessageBubble = (props: MessageBubbleProps) => {
    ...
    useEffect(() => {
        ...
        // Compact mode anchors a fixed-position picker to the toolbar so a
        // full-width row doesn't push the picker off-screen. Mirrors the
        // viewport-clamped math used by TaskCommentBubble.
        if (isCompact) {
