export const settings = {
    ...
    mentionGroups: {
        heading: "Mention groups",
        description:
            "Team-scoped @groups. Anyone in your team can mention a group in chat, task comments, or task bodies; every member of the group is notified.",
        groupsHeading: "Groups",
        newGroup: "New group",
        namePlaceholder: "group-name (lowercase)",
        descriptionPlaceholder: "Description (optional)",
        empty: "No groups yet. Click + to create one.",
        selectPrompt: "Select a group on the left to manage its members.",
        modalHeading: "Mention group",
        notFound: "Group not found.",
        deleteGroup: "Delete group",
        deleteConfirm: "Delete @{name}? This cannot be undone.",
        addDescription: "Add a description…",
        membersCount: "Members ({count})",
        noMembers: "No members yet. Add some below.",
        removeMember: "Remove member",
        addMembers: "Add members",
        searchMembersPlaceholder: "Search team members…",
        noMatchingMembers: "No matching team members.",
        everyoneAlreadyMember: "Everyone is already a member.",
    },
    customEmoji: {
        heading: "Custom emoji",
        description:
            "Team-wide emoji, animated GIFs welcome. Type :name: in any editor, pick them from the emoji picker, or use them as reactions. Anyone on the team can add one; only the uploader can remove it.",
        chooseImage: "Choose image",
        namePlaceholder: "emoji-name (a-z, 0-9, _ + -)",
        addEmoji: "Add emoji",
        invalidFileType: "Use a .png, .jpg, .gif, .webp or .svg file.",
        fileTooLarge: "Emoji images must be 512 KB or smaller.",
        uploadFailed: "Upload failed — is the name already taken?",
        invalidName: "Names are 1-50 chars of a-z, 0-9, _, + or -.",
        empty: "No custom emoji yet. Add the first one!",
        deleteEmoji: "Delete (old messages keep it)",
    },
    developer: {
        keys: {
            title: "API keys",
