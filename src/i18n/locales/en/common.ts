export const common = {
    ...
    editor: {
        ...
        placeholderEmpty: "Start typing...",
        placeholderDefault: "Type something...",
        placeholderHeading: "Custom heading placeholder",
        wrapAll: "Wrap all content",
        unwrapAll: "Unwrap all content",
        wrapCode: "Wrap code blocks",
        unwrapCode: "Unwrap code blocks only",
        ...
        gifNotConfigured: "GIF search isn't configured on this server (missing GIPHY key).",
        gifNoResults: "No GIFs found.",
        gifLoadMore: "Load more",
        gifLoading: "Loading…",
        ...
        hashSharedNote: "Shared note",
        hashTeamNote: "Team note",
        hashMyNote: "My note",
        hashGroupChat: "Group chat",
        hashProject: "Project",
        hashNoteFallback: "note",
        hashChatFallback: "chat",
        hashProjectFallback: "project",
        delete: "Delete",
        colors: "Colors",
        download: "Download",
    ...
    featureError: {
        title: "Something went wrong in {feature}.",
        recovery: "Switch to another tab to keep working, or refresh the page.",
    },
