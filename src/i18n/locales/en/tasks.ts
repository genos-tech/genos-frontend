export const tasks = {
    ...
    errors: {
        ...
        subTaskProjectMoveForbidden:
            "This task lives in the project of the task or milestone it sits under. Move that one to bring this task with it.",
    },
    ...
    tooltips: {
        ...
        milestoneTaskProjectLocked:
            "A task in a milestone lives in the milestone's project. Move the milestone to move this one with it.",
    ...
    activity: {
        ...
        onFile: "on {file}",
        autoClosedWhen: "Auto-closed when",
        pullRequest: "a pull request",
        wasMerged: "was merged",
        linkedPullRequest: "Linked pull request",
        justNow: "just now",
        ...
        verbs: {
            ...
            titleChanged: "renamed this from",
            statusChanged: "changed status from",
            priorityChanged: "changed priority from",
            effortChanged: "changed effort from",
            assigneeChanged: "reassigned from",
            reporterChanged: "changed reporter from",
            dueDateChanged: "changed due date from",
            descriptionEdited: "edited the description",
            tagsChanged: "updated the tags",
            parentChanged: "changed parent task from",
            milestoneChanged: "changed milestone from",
            sprintChanged: "changed sprint from",
            closed: "closed this",
            reopened: "reopened this",
            deleted: "deleted this",
            attachmentAdded: "attached",
            attachmentRemoved: "removed attachment",
            commentAdded: "posted a comment",
            commentEdited: "edited a comment",
            commentDeleted: "deleted a comment",
            milestoneAssigneeAdded: "added",
            milestoneAssigneeRemoved: "removed",
        },
    },
    ...
    dashboard: {
        ...
        tags: {
            ...
            emptyBody: "Add tags to tasks or milestones to see tag-based insights here.",
            inUse: "Tags in use",
    ...
    diagram: {
        ...
        confirmDelete: "Delete this task and all its sub-tasks?",
        errors: {
            load: "Couldn't load the task graph.",
            update: "Update failed.",
            delete: "Delete failed.",
            reparent: "Re-parent failed.",
        },
        schedule: {
            closed: "Closed",
            dueToday: "Due today",
    ...
    mobile: {
        ...
        newProject: "New project",
        newTag: "New tag",
        pickProject: "Pick a project from the sidebar to see its tasks.",
        noOpenTasks: "No open tasks in this project.",
        untitled: "(untitled)",
    },
    mentionHover: {
