import { TeamProjectsResponse, UserProps } from '../../types'
...
async function loadTeamProjects(props: LoadSearchListProps): Promise<TeamProjectsResponse[]> {
    ...
    try {
        ...
        const data: TeamProjectsResponse[] = await response.json();
